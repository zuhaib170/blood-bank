...
(1, 'Anuj', 'anuj@gmail.com', '9923471025', 'I need O+ Blood.', '2025-05-21 06:03:51', 1),
(2, 'zuhaib', '4561239875', 'zuhaib@gmai', 'need blood', '2025-05-21 06:06:14', NULL);
...
CREATE TABLE `donors` (
  ...
  `donor_number` varchar(10) NOT NULL CHECK (`donor_number` regexp '^[0-9]{10}$'),
  `donor_mail` varchar(100) NOT NULL,
  `donor_age` int(11) DEFAULT NULL CHECK (`donor_age` >= 18 and `donor_age` <= 65),
