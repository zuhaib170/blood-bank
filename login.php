...
<body background="admin_image/blood-cells.jpg">
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:auto; background-image:url('admin_image/glossy1.jpg');">
        <div class="card-body">
          ...
          <div class="row justify-content-lg-center">
            <div class="col-lg-4 mb-4 text-center"><br>
              <input type="submit" name="login" class="btn btn-primary" value="LOGIN" style="cursor:pointer">
              <a href="../home.php" class="btn btn-secondary ml-2">Back to Home</a>
            </div>
          </div>
        </div>
      </div>
