...
<?php if(isset($_POST['search'])){
  ...
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
    ...
    <b>Mobile No. :</b> <b><?php
        $mobile = $row['donor_number'];
        if (ctype_digit($mobile)) {
            echo $mobile;
        } else {
            echo "Invalid Mobile No."; // Or display an empty string, or handle the error as needed
        }
    ?></b><br>
    <b>Gender :</b> <b><?php echo $row['donor_gender']; ?></b><br>
    <b>Age :</b> <b><?php
        $age = $row['donor_age'];
        if (ctype_digit($age)) {
            echo $age;
        } else {
            echo "Invalid Age"; // Or display an empty string, or handle the error as needed
        }
    ?></b><br>
    <b>Address :</b> <b><?php echo $row['donor_address']; ?></b><br>
</p>
          </div>
        </div>
  </div>
